...
if __name__ == "__main__":
    ...
    model_name_or_path = args.directory

    # model_name_or_path='/home/yanghongyu/pro/llama-2-7b-chat-hf'
    ...
    # file_name = "test.json"
    file_path = "../data/gpt_five_pro.json"
    with open(file_path, "r", encoding='utf-8') as f:
        infer_data = {line_index: json.loads(l) for line_index, l in enumerate(f.readlines())}
