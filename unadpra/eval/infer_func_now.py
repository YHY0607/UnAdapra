...
def generate_pipeline(model, tokenizer, prompts, add_special_tokens=False, gen_kwarg={"max_new_tokens": 128, "num_beams": 1, "do_sample": False,}, batch_size =8):
    def pipeline(prompts):
        ...
        truncated_prompts = [p + "\n[END]:" for p in truncated_prompts]
        model_inputs = tokenizer(
            truncated_prompts, 
            add_special_tokens=add_special_tokens,
            padding=True,
